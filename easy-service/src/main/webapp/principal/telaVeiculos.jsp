								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaMecanica"><img
												class="img-fluid w-100" src="images/meca.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Mecanica</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaEletrica"><img
												class="img-fluid w-100" src="images/elet.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Auto Eletrica</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaBorracharia"><img
												class="img-fluid w-100" src="images/borra.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Borracharia</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaLavacao"><img
												class="img-fluid w-100" src="images/lava.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Lavação</a>
										</h6>
									</div>
								</div>
