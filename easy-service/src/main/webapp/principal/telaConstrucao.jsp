								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaAlvenaria"><img
												class="img-fluid w-100" src="images/Alve.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Alvenaria</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/const.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Construção</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/azu.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Azulejista</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/porce.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Porcelanato
												Liquido</a>
										</h6>
									</div>
								</div>
