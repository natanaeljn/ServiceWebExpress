								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaFront"><img
												class="img-fluid w-100" src="images/front.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Front End</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaBack"><img
												class="img-fluid w-100" src="images/back.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Back End</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaFull"><img
												class="img-fluid w-100" src="images/full.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Full-Stack</a>
										</h6>
									</div>
								</div>
