								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaBanho"><img
												class="img-fluid w-100" src="images/banho.png" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Banho e Tosa</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaWalker"><img
												class="img-fluid w-100" src="images/walker.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Dog Walker</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaVeterinario"><img
												class="img-fluid w-100" src="images/vete.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Medicina
												Veterinaria</a>
										</h6>
									</div>
								</div>
