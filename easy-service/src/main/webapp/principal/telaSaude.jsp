									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/manicure.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Manicure</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/pedicure.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Pedicure</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/podologia-1.jpg"
												alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Podologia</a>
										</h6>
									</div>
								</div>
								<!-- PRODUCT-->
								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaMassagem"><img
												class="img-fluid w-100" src="images/massagem.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Massagem</a>
										</h6>
									</div>
								</div>
								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaQuiropraxia"><img
												class="img-fluid w-100" src="images/quiro.jpg" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Quiropraxia</a>
										</h6>
									</div>
								</div>
								...
								<div class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white bg-"></div>
											<a class="d-block"
												href="<%=request.getContextPath()%>/ServletListagem?acao=paginaCabeleleiro"><img
												class="img-fluid w-100" src="images/cabelo.png" alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Cabeleleiro</a>
										</h6>
									</div>
								</div>
									...
									<div class="product text-center">
										<div class="mb-3 position-relative">
											...
											<a class="d-block"
												...
												class="img-fluid w-100" src="images/naildesigner.jpg"
												alt="..."></a>
											<div class="product-overlay"></div>
										</div>
										<h6>
											<a class="reset-anchor" href="detail.html">Nail Designer</a>
										</h6>
									</div>
								</div>
