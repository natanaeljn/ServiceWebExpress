			...
			<section
				...
				<div class="container py-5">
					<div class="row px-4 px-lg-5">
						<div class="col-lg-6">
							<p class="text-muted small text-uppercase mb-2">Desculpe o
								Transtorno , ocorreu um erro no sistema</p>
							<h1 class="h2 text-uppercase mb-3">Volte para a tela inicial
								ou entre em contato com o suporte para duvidas : 47988084373</h1>
